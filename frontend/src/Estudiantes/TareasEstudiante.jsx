...
const TareasEstudiante = () => {
  const [tareas, setTareas] = useState([
    { id: 1, nombre: 'Registrar docente', progreso: '40%', imagenes: [], sprint: 1 },
    { id: 2, nombre: 'Visualizar planilla', progreso: '20%', imagenes: [], sprint: 1 },
    { id: 3, nombre: 'Registrar equipo', progreso: '0%', imagenes: [], sprint: 2 },
    { id: 4, nombre: 'Autentificar usuarios', progreso: '100%', imagenes: [], sprint: 1 },
    { id: 5, nombre: 'Registrar estudiantes', progreso: '80%', imagenes: [], sprint: 2 }
  ]);
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <table>
        ...
        <tbody>
          {tareas
            .filter((tarea) => tarea.sprint === selectedSprint)
            .map((tarea) => (
              <tr key={tarea.id}>
                <td>{tarea.nombre}</td>
